...
private:
    ...
    std::vector<std::string> m_ScatterCubesNames;


    // Scatter spheres parameters
    int                        m_NumScatterSpheres = 10;
    static constexpr int       MaxSmallSpheres     = 50;
    int                        m_NumScatterCubes = 10;
    static constexpr int       MaxSmallCubes     = 50;
    std::vector<float3>        m_ScatterSpherePositions;
    static std::vector<float3> smallSpherePositions;
    std::vector<float3>        m_ScatterCubesPositions;
    static std::vector<float3> smallCubesPositions;
